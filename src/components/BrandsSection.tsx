            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden rounded-t-[calc(var(--radius)-1px)]">
                <img
                  ...
                  className="w-full h-full object-cover brightness-[0.5] group-hover:brightness-[0.65] group-hover:scale-105 transition-all duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-card via-transparent to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <Film size={20} className="text-primary mb-3" />
                  <h3 className="text-3xl md:text-4xl font-black tracking-tight text-white">SOLAR</h3>
                </div>
              </div>
              <div className="p-6 pt-4">
                ...
                <button
                  ...
                  className="mt-5 inline-flex items-center gap-2 bg-primary text-primary-foreground font-bold text-[12px] px-6 py-2.5 rounded-full hover:shadow-lg hover:scale-[1.03] transition-all duration-300"
                >
            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden rounded-t-[calc(var(--radius)-1px)]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  ...
                  <h3 className="text-3xl md:text-4xl font-black tracking-tight text-white">InHub</h3>
                </div>
              </div>
              <div className="p-6 pt-4">
                <p className="text-muted-foreground text-[13px] leading-relaxed">
