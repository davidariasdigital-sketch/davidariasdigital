        ...
        <div className="flex flex-col md:flex-row items-center md:items-center gap-8 md:gap-12">
          ...
          <motion.div
            ...
            <h1 className="leading-none tracking-[-0.03em] flex flex-col items-center md:items-start gap-2">
              ...
              <img alt="DIGITAL" className="block w-full max-w-[260px] sm:max-w-[340px] md:max-w-[480px] h-auto" src="/lovable-uploads/ea292b88-743f-42b5-ae68-779729afb4a3.png" />
            </h1>
            ...
            <motion.div
              ...
              className="flex flex-col gap-1.5 md:gap-2 items-center md:items-start">
            ...
            <motion.div
              ...
              className="flex flex-wrap gap-2.5 md:gap-3 pt-1 md:pt-2 justify-center md:justify-start">
              <a
